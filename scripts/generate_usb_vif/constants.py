...
SOURCE_PDOS = "source-pdos"
SOURCE_PDO = "SrcPDO"
SOURCE_PDO_SUPPLY_TYPE = "Src_PDO_Supply_Type"
SOURCE_PDO_PEAK_CURRENT = "Src_PDO_Peak_Current"
SOURCE_PDO_MAX_CURRENT = "Src_PDO_Max_Current"
SOURCE_PDO_VOLTAGE = "Src_PDO_Voltage"
SOURCE_PDO_MIN_VOLTAGE = "Src_PDO_Min_Voltage"
SOURCE_PDO_MAX_VOLTAGE = "Src_PDO_Max_Voltage"
SOURCE_PDO_MAX_POWER = "Src_PDO_Max_Power"
PD_POWER_AS_SOURCE = "PD_Power_As_Source"
NUM_SOURCE_PDOS = "Num_Src_PDOs"
EPR_SUPPORTED_AS_SOURCE = "EPR_Supported_As_Src"
...
VIF_ELEMENTS = ["VIF_Specification", "VIF_App", "Vendor", "Name", "Version",
                ...
                FR_SWAP_REQD_TYPE_C_CURRENT_AS_INITIAL_SOURCE, SOURCE_PDOS, SOURCE_PDO,
                SOURCE_PDO_SUPPLY_TYPE, SOURCE_PDO_PEAK_CURRENT, SOURCE_PDO_MAX_CURRENT,
                SOURCE_PDO_VOLTAGE, SOURCE_PDO_MIN_VOLTAGE, SOURCE_PDO_MAX_VOLTAGE,
                SOURCE_PDO_MAX_POWER, PD_POWER_AS_SOURCE, NUM_SOURCE_PDOS,
                EPR_SUPPORTED_AS_SOURCE, ]

DT_VIF_ELEMENTS = {
    SINK_PDOS: "SnkPdoList",
    SOURCE_PDOS: "SrcPdoList",
}
